...
export function TechnicalDiv({name, lastnames, birthDate,profession,btnVer}) {
    return (
        <>
            <div className="request relative flex w-full h-fit p-3 mb-5 bg-white rounded-2xl">
                <div className="information-request w-7/12">
                    <ul>
                        ...
                        <li>
                            <p className="font-medium text-gray-700	"><b className="text-black">EDAD:</b> {birthDate}</p>
                        </li>
                    </ul>
                </div>
