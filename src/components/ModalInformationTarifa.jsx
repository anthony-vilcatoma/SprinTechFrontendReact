                    ...
                    <div className="flex-col justify-center items-center">
                        <div className="flex justify-between items-center">
                            ...
                            <div className="bg-white flex justify-center items-center w-5/12 mb-5 mr-5 p-4 shadow-lg  rounded-lg">
                                ...
                                <p className='text-gray-400 font-bold  text-sm'>S/16</p>
                            </div>
                        </div>
                        <div className="bg-white mb-5 p-4 shadow-lg  rounded-lg">
                        ...
                        <div className="flex justify-center items-center">
                            <button className='p-2 rounded-lg mr-5 font-semibold text-white bg-gray-400'>Rechazar</button>
                            <button className='p-2 rounded-lg font-semibold bg-personalized text-white '>Aceptar</button>
                        </div>
                    </div>
